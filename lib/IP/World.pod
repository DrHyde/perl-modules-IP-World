...
included application downloads and combines the databases
...
=item * 1: Mmap, keeps data in Mmap memory, may reduce total memory requirement of sibling processes. If your system doesn't support Mmap, 1 operates like 0.
...
This uses one of the two data sources that IP-World uses.
